...
#Прежде всего я исправил то как импортировали математические функции.
#Далее большинство формул были записаны некорректно.
#И так как питон строго типированный язык программирования не было от слова совсем расставлены форматы строк.
